...
import com.example.aparts.services.AdminService;
...
public class AdminController {
    ...
    public String showUserInfo(
            ...
            Model model,
            @AuthenticationPrincipal Client user) throws ClientException {
    ...
    public String editUser(@Parameter(description = "User to edit", required = true) @PathVariable(value = "user") Client user, Model model){
        model.addAttribute("user", user);
    ...
    public String userBan(
            @Parameter(description = "User ID", required = true) @PathVariable("id") Long id) throws ClientException {
    ...
    public String showOrder(
            ...
            @AuthenticationPrincipal Client client, Model model) throws ShoppingCartException {
        model.addAttribute("user", client);
    ...
    public String orderEdit(
            @Parameter(description = "Order ID", required = true) @PathVariable("id") Long id,
            @Parameter(description = "New status", required = true) @RequestParam("orderStatus") String status) throws ShoppingCartException {
