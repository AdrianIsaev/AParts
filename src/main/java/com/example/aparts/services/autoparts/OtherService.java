...
import com.example.aparts.repositories.autoparts.OtherRepository;
...
public class OtherService extends AbstractService<Other, OtherRepository>{
    ...
    @Autowired
    public OtherService(ClientRepository clientRepository, ImageRepository imageRepository, OtherRepository otherRepository) {
        super(clientRepository, imageRepository, otherRepository);
    }
    @Transactional(readOnly = true)
    public Page<Other> getChassisByName(String name, Pageable pageable){
